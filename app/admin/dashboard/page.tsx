...
export default function AdminDashboard() {
  ...
  const generatePDF = async () => {
    try {
      ...
      doc.text("MLT ELECTION RESULTS", pageWidth / 2, yPosition, { align: "center" })
      yPosition += 10

      doc.setFontSize(14)
      doc.setFont("helvetica", "normal")
      doc.text("Medical Laboratory Science Students Association (MLT)", pageWidth / 2, yPosition, { align: "center" })
      yPosition += 8
      ...
      doc.text(
        "This is an official election result document generated by the MLT Voting System.",
        pageWidth / 2,
        yPosition,
        { align: "center" },
      )
      ...
      doc.text("MLT President", pageWidth - margin - 30, yPosition, { align: "center" })

      // Save the PDF
      const fileName = `MLT_Election_Results_${new Date().toISOString().split("T")[0]}.pdf`
      doc.save(fileName)
    } catch (error) {
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <ul className="text-sm text-gray-600 space-y-1">
                        <li>• MLT & ATU official headers</li>
